...
export class VideoPage {
  ...
  getVideoList()
  {
    ...
    this.filter.type = this.Data.video_type
    console.log(this.filter);

    this.dbService.onPostRequestDataFromApi({'filter' : this.filter},'app_master/videoList', this.dbService.rootUrl).subscribe( r =>
      {
            console.log(r);
