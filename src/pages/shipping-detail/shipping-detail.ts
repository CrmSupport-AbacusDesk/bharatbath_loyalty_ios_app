...
export class ShippingDetailPage {
  ...
  getShippedDetail()
  {
    ...
    {
      console.log();
      this.dbService.onPostRequestDataFromApi({'gift_id' :this.karigar_gift_id,'karigar_id':this.dbService.userStorageData.id},'app_karigar/giftDetail', this.dbService.rootUrl).subscribe( r =>
        {
          console.log(r);
